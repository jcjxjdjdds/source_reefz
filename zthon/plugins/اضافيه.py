...
ZelzalDV_cmd = (
    "𓆩 [𝐒𝐎𝐔𝐑𝐂𝐄 ᴠᴇɢᴀ✹-اوامر رشق المشاهدات](t.me/VeGaSouRce) 𓆪\n\n"
    "**⏎** اهلا بك في اوامر رشق مشاهدات\n"
    "**⏎**لاستعمال الامر ⏎ 𐇮.رشق تلي +رابط المنشور ⏎\n"
    "\n𓆩 [𐇮 𝗦𝗢𝗨𝗥𝗖𝗘 VeGa  𐇮](t.me/VeGaSouRce) 𓆪"
        "\n𓆩 [𐇮 ⧛𝐙𝐎𝐊𝐀 الهہـيـٖ͡ـ͢ـبـه 𐇮](t.me/O_m_xl) 𓆪"
                  "\n𓆩 [𐇮 ⧛ᴋ ɪ ᴍ ᴍ ʏ الهہـيـٖ͡ـ͢ـبـه 𐇮](t.me/ToPVeGa) 𓆪"
                                     "\n𓆩 [𐇮 ⧛ᴢ ᴏ ᴍ ʙ ɪ ᴇ الهہـيـٖ͡ـ͢ـبـه 𐇮](t.me/Zo_Mbi_e) 𓆪"
)
...
async def add_sudo_user(event):
    ...
    output += "**✾╎يتم الان اعـادة تشغيـل بـوت فيجا انتظـر 2-1 دقيقـه ▬▭ ...**"
...
async def _(event):  # sourcery no-metrics
    ...
    output = (
        result + "**✾╎يتم الان اعـادة تشغيـل بـوت فيجا انتظـر 2-1 دقيقـه ▬▭ ...**\n"
    )
    if errors != "":
        output += "\n**- خطــأ :**\n" + errors
