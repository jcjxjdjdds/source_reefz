...
LOGS = logging.getLogger("سورس فيـجا")
...
async def startup_process():
    ...
    async def start_bot():
      try:
          List = ["def_Zoka","chat_refz","reffezk","TY_X_X","KALAYISH","rev_fxx","FH_EF","x_wwl","K_K_Q_L","GRoUpVeGa","zszxzz"]
