                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @O_m_xl\
                                  \n\n--------بـدء تتبـع سجـل فيـجا ᴠᴇɢᴀ𖤊--------\
                        ...
                        link = "[zoka (https://t.me/O_m_xl)"
                        text = (
                            "**✘ تقـريـر إشعـار فيـجا ᴠᴇɢᴀ𖤊 ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر إشعـار فيـجا ᴠᴇɢᴀ𖤊 ✘**\n\n "
                        link = "[zoka (https://t.me/O_m_xl)"
