    ...
    try:
        ...
        if BOTLOG:
            ...
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                ...
                caption="**•⎆┊تـم بـدء تشغـيل سـورس فيـجا الخاص بك .. بنجاح 🧸♥️**",
                
                buttons=[(Button.url("𝗦َِ𝗼َِ𝗨َِ𝗿َِ𝗖َِ𝗲 َِᴠᴇɢᴀ", "https://t.me/VeGaSouRce"),)],
...
zthon = {"@VeGaSouRce", "@KALAYISH", "@lackhak", "@source_refz"}
async def saves():
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(
            ...
            "كـروب السجـل فيـجا", zedub, Config.TG_BOT_USERNAME, descript, photozed
